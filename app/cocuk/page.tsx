...
export default function CocukPage() {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products?category=cocuk')
      const data = await response.json()
      
      if (data.success) {
        // Ürünleri çocuk sayfası için formatla
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">Çocuk Kategorisi</h1>
          <p className="text-xl opacity-90">
            Çocuklarınız için en kaliteli ve şık ürünler
          </p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex space-x-2">
                      {['Mavi', 'Kırmızı', 'Yeşil', 'Siyah', 'Beyaz'].map((color) => (
                        <button
                          key={color}
