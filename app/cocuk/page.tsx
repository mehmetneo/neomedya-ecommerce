...
export default function CocukPage() {
  ...
  const [selectedColor, setSelectedColor] = useState('Mavi')
  const [products, setProducts] = useState(cocukUrunleri)
  ...
  useEffect(() => {
    ...
    const handleProductsUpdated = (event: CustomEvent) => {
      ...
      // Sadece çocuk kategorisindeki ürünleri filtrele
      const cocukProducts = updatedProducts.filter((product: any) => product.category === 'Çocuk')
      setProducts(cocukProducts.length > 0 ? cocukProducts : cocukUrunleri)
    }
    ...
    if (savedProducts) {
      ...
      const cocukProducts = allProducts.filter((product: any) => product.category === 'Çocuk')
      if (cocukProducts.length > 0) {
        setProducts(cocukProducts)
      }
    }
  ...
  const handleAddToCart = (product: any, size: string = 'M', color: string = 'Mavi') => {
    const cartItem = {
      id: product.id,
      name: product.name,
      price: product.price,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          {/* Başlık */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Çocuk Koleksiyonu</h1>
            <p className="text-gray-600">En sevimli çocuk kıyafetleri ve aksesuarları</p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex space-x-2">
                        {['Mavi', 'Kırmızı', 'Yeşil', 'Sarı'].map((color) => (
                          <button
                            key={color}
