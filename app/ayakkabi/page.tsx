...
const ayakkabiUrunleri = [
  {
    id: '1',
    name: 'Nike Air Max Spor Ayakkabı',
    price: 899.99,
  ...
  },
  {
    ...
    price: 399.99,
    image: 'https://images.unsplash.com/photo-1607522370275-f14206abe5d3?w=500&h=600&fit=crop',
    rating: 4.6,
    reviews: 298
  }
]
      ...
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Rahat ve şık ayakkabı modelleri
          </p>
              ...
              <div key={product.id} className="card overflow-hidden cursor-pointer" onClick={() => handleProductClick(product)}>
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 hover:opacity-100 transition-opacity">
                    <button className="w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-800 hover:text-white transition-colors">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold mb-2">Numara</h4>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        {['Siyah', 'Beyaz', 'Mavi', 'Kırmızı', 'Gri'].map((color) => (
