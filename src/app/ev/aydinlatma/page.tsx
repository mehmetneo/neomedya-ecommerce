...
import { Home, ShoppingCart, Heart, Star, Filter, Grid, List, ArrowLeft, Zap } from 'lucide-react'
...
const Aydinlatma = () => {
  ...
  const products = [
    { id: 1, name: "LED Avize Modern", price: 1299, originalPrice: 1599, image: "💡", rating: 4.8, reviews: 156, brand: "LightPro", discount: 15, inStock: true },
    { id: 2, name: "Tavan Lambası LED", price: 899, originalPrice: 899, image: "💡", rating: 4.6, reviews: 89, brand: "BrightHome", discount: 0, inStock: true },
    { id: 3, name: "Masa Lambası Modern", price: 399, originalPrice: 499, image: "💡", rating: 4.7, reviews: 234, brand: "LightPro", discount: 20, inStock: true },
    { id: 4, name: "Sarkıt Avize Kristal", price: 2499, originalPrice: 2999, image: "💎", rating: 4.5, reviews: 67, brand: "BrightHome", discount: 0, inStock: false },
    { id: 5, name: "LED Şerit Işık", price: 199, originalPrice: 299, image: "✨", rating: 4.4, reviews: 123, brand: "LightPro", discount: 10, inStock: true },
    { id: 6, name: "Bahçe Lambası Solar", price: 599, originalPrice: 599, image: "🌙", rating: 4.9, reviews: 89, brand: "BrightHome", discount: 0, inStock: true },
    { id: 7, name: "Küre Avize Büyük", price: 1599, originalPrice: 1899, image: "💡", rating: 4.8, reviews: 156, brand: "LightPro", discount: 15, inStock: true },
    { id: 8, name: "Spot Lamba Seti", price: 799, originalPrice: 899, image: "💡", rating: 4.6, reviews: 89, brand: "BrightHome", discount: 0, inStock: true }
  ]

  const brands = ["LightPro", "BrightHome", "CrystalLight"]
  const categories = ["Avizeler", "Tavan Lambaları", "Masa Lambaları", "Bahçe Aydınlatma", "LED Şeritler", "Spot Lambalar"]
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
              ...
              {/* Energy Efficiency */}
              <div className="mb-6">
                <h4 className="font-medium text-gray-900 mb-3">Enerji Verimliliği</h4>
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="rounded text-orange-600 focus:ring-orange-500" />
                    <span className="text-sm text-gray-700">LED Aydınlatma</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="rounded text-orange-600 focus:ring-orange-500" />
                    <span className="text-sm text-gray-700">Solar Enerji</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="rounded text-orange-600 focus:ring-orange-500" />
                    <span className="text-sm text-gray-700">Akıllı Kontrol</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Aydınlatma Ürünleri</h2>
              ...
              {filteredProducts.map((product) => (
                <div key={product.id} className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow ${
                  ...
                  <div className={`relative ${viewMode === 'list' ? 'w-32 h-32 flex-shrink-0' : ''}`}>
                    ...
                    <div className={`bg-gradient-to-br from-yellow-100 to-orange-100 rounded-lg flex items-center justify-center ${
