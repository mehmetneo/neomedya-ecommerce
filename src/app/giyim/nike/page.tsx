...
import { ArrowLeft, Star, Heart, Filter, Grid, List, Search } from 'lucide-react'
  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Nike</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg p-8 mb-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Nike Koleksiyonu</h2>
            <p className="text-lg opacity-90 mb-6">
              "Just Do It" - Spor ve performans için tasarlanmış en yeni Nike ürünleri
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">👟 Spor Ayakkabı</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">👕 Spor Giyim</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">🧥 Tech Fleece</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">🩳 Shorts</span>
            </div>
          </div>
        </section>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            ...
            <span className="text-gray-600">{nikeProducts.length} Nike ürünü bulundu</span>
          </div>
          ...
          {nikeProducts.map((product) => (
            <div key={product.id} className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow ${
              ...
              <div className={`relative ${viewMode === 'list' ? 'w-32 h-32 flex-shrink-0' : ''}`}>
                ...
                <div className={`bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center ${
