        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Çocuk Giyim</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg p-8 mb-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Çocuk Giyim Koleksiyonu</h2>
            <p className="text-lg opacity-90 mb-6">
              Rahat, dayanıklı ve şık çocuk giyim ürünleri. Çocuklarınız için en kaliteli markalar.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">👕 T-Shirt</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">👖 Eşofman</span>
          ...
          {products.map((product) => (
            <div key={product.id} className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow ${
              ...
              <div className={`relative ${viewMode === 'list' ? 'w-32 h-32 flex-shrink-0' : ''}`}>
                ...
                <div className={`bg-gradient-to-br from-green-100 to-blue-100 rounded-lg flex items-center justify-center ${
