  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-black to-gray-800 text-white rounded-lg p-8 mb-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Adidas Koleksiyonu</h2>
            <p className="text-lg opacity-90 mb-6">
              "Impossible is Nothing" - Spor ve yaşam tarzı için tasarlanmış Adidas ürünleri
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">🧥 Track Jacket</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">🩳 Training Shorts</span>
            </div>
          </div>
        </section>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            ...
            <span className="text-gray-600">{adidasProducts.length} Adidas ürünü bulundu</span>
          </div>
          ...
          {adidasProducts.map((product) => (
            <div key={product.id} className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow ${
              ...
              <div className={`relative ${viewMode === 'list' ? 'w-32 h-32 flex-shrink-0' : ''}`}>
                ...
                <div className={`bg-gradient-to-br from-gray-100 to-black rounded-lg flex items-center justify-center ${
