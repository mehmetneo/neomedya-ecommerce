...
import { Headphones, ShoppingCart, Heart, Star, Filter, Grid, List, ArrowLeft, Watch, Zap } from 'lucide-react'
...
const Aksesuarlar = () => {
  ...
  const products = [
    { id: 1, name: "AirPods Pro 2", price: 5999, originalPrice: 5999, image: "🎧", rating: 4.8, reviews: 156, brand: "Apple", discount: 0, inStock: true, type: "Headphones", color: "White" },
    { id: 2, name: "Sony WH-1000XM5", price: 8999, originalPrice: 9999, image: "🎧", rating: 4.9, reviews: 89, brand: "Sony", discount: 10, inStock: true, type: "Headphones", color: "Black" },
    { id: 3, name: "Apple Watch Series 9", price: 12999, originalPrice: 12999, image: "⌚", rating: 4.7, reviews: 234, brand: "Apple", discount: 0, inStock: true, type: "Smartwatch", color: "Aluminum" },
    { id: 4, name: "Samsung Galaxy Watch 6", price: 7999, originalPrice: 8999, image: "⌚", rating: 4.6, reviews: 67, brand: "Samsung", discount: 12, inStock: false, type: "Smartwatch", color: "Silver" },
    { id: 5, name: "Bose QuietComfort 45", price: 6999, originalPrice: 7999, image: "🎧", rating: 4.5, reviews: 123, brand: "Bose", discount: 15, inStock: true, type: "Headphones", color: "Black" },
    { id: 6, name: "Garmin Fenix 7", price: 15999, originalPrice: 15999, image: "⌚", rating: 4.8, reviews: 89, brand: "Garmin", discount: 0, inStock: true, type: "Smartwatch", color: "Titanium" },
    { id: 7, name: "Jabra Elite 85t", price: 3999, originalPrice: 4999, image: "🎧", rating: 4.4, reviews: 156, brand: "Jabra", discount: 20, inStock: true, type: "Headphones", color: "Titanium" },
    { id: 8, name: "Fitbit Sense 2", price: 5999, originalPrice: 6999, image: "⌚", rating: 4.3, reviews: 89, brand: "Fitbit", discount: 15, inStock: true, type: "Smartwatch", color: "Black" }
  ]

  const brands = ["Apple", "Sony", "Samsung", "Bose", "Garmin", "Jabra", "Fitbit"]
  const categories = ["Headphones", "Smartwatch", "Earbuds", "Fitness Tracker", "Gaming", "Wireless"]
  const types = ["Bluetooth", "Noise Cancelling", "Water Resistant", "GPS", "Heart Rate Monitor"]
        ...
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">Kablosuz</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="rounded text-blue-600 focus:ring-blue-500" />
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="rounded text-blue-600 focus:ring-blue-500" />
                    <span className="text-sm text-gray-700">Aktif Gürültü Engelleme</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Teknoloji Aksesuarları</h2>
                ...
                <div key={product.id} className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow ${
                  ...
                  <div className={`flex-1 ${viewMode === 'list' ? 'flex flex-col justify-between' : 'mt-4'}`}>
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">{product.brand} • {product.type} • {product.color}</p>
